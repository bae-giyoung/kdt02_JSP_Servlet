...
<body>
	<h2>국가 명의 일부를 입력 받아서 해당 국가의 도시의 이름과 인구를 검색해서 출력</h2>
	<form action="DBMission03.jsp" name="dbmission03" method="post" onsubmit="return isValidForm(this);">
		국가명: <input type="text" name="name" value="" /><br />
	...
	if (nameStr != null) {
		...
		String sql = "select city.name, city.population from country, city where country.code=city.countrycode and country.name like ?";
