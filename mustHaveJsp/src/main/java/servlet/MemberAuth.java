...
public class MemberAuth extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		String msId = application.getInitParameter("MySQLID");
		String msPass = application.getInitParameter("MySQLPwd");
		
		// DAO 생성
		dao = new MemberDAO(driver, connectUrl, msId, msPass);
	}
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(memberName != null) {
			...
			if(admin_id.equals(id)) //관리자
				req.setAttribute("authMessage", memberName + "는 최고 관리자입니다.");
			else // 비회원
